...
class MessageCard extends React.Component {
    AvatarColor = [deepOrange, pink, purple, red, indigo, deepPurple, cyan, green, blue, grey, amber, lightBlue, lightGreen, teal, lime, brown, yellow, amber];
    constructor(props){
        super(props);
        this.setState({
            ColorIndex: 0,
            ...
            <>
                <Grid container maxWidth >
                    <Grid item xs={1} sx={{display: "flex", padding: 1}} justifyContent="center">
                        <Avatar sx={{bgcolor: AvatarColor[this.state.ColorIndex][500]}}>{this.props.sender?this.props.sender.slice(0,1).toUpperCase():""}</Avatar>
                    </Grid>
